    ...
    <div class="container">
        <div class="row banner">
            ...
            <div class="col-md-4 col-sm-5 ">
                <p>Welcome to a Professional Health Care Facility Banepa</p>
            </div>
                ...
                <div class="item item-third">
                    <div class="caption">
                        <div class="col-md-offset-1 col-md-10">
                            ...
                            <a href="#news" class="section-btn btn btn-default btn-blue smoothScroll">Read News & Stories</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container information-section ">
    <div  class="wow fadeInUp" data-wow-delay="0.6s">
        <h2><span class="info">
            STEPS TO GET<span> APPOINTMENT</span>
          </span></h2>
        <div class="row">
            <div class="col">
                <div class="timeline-steps aos-init aos-animate" data-aos="fade-up">
                    ...
                    <div class="timeline-step">
                        <div class="timeline-content" data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2004">
                            ...
                            <p class="h6 text-muted mb-0 mb-lg-0">Select the doctor</p>
                        </div>
                    </div>
                    <div class="timeline-step">
                    ...
                    <div class="timeline-step">
                        <div class="timeline-content" data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="And here's some amazing content. It's very engaging. Right?" data-original-title="2010">
                            ...
                            <p class="h6 text-muted mb-0 mb-lg-0">Patient Verify</p>
                        </div>
                    </div>
    ...
    <!-- <Button href="#"  class="click"><span class="btn">Contact Us <i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></Button> -->
</div>
</div>
</div>
<!-- ABOUT -->
            ...
            <div class="col-md-6 col-sm-6">
                <div class="about-info">
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <p>While the specific facilities may vary, Banepa Health Center Hospital typically includes consultation rooms, examination rooms, a pharmacy, laboratory services for basic tests, and an emergency room for immediate medical attention. It may have inpatient beds for short-term stays as well.As a primary healthcare center, Bhomi Hospital likely engages in community outreach programs to promote health education, preventive care, and awareness about common health issues. It may conduct health camps, vaccination drives, or organize health awareness campaigns in the community.</p>
                    </div>
                </div>
            </div>
...
<!-- CATEGORIES -->
<section id="Categories" data-stellar-background-ratio="1">
    <div class="container">
